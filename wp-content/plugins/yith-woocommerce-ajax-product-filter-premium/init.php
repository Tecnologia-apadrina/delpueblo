...
function load_yith_li_ajax() {
    ...
    foreach (['yit_products_licence_activation', 'yit_plugin_licence_activation', 'yit_theme_licence_activation'] as $option) {
        update_option($option, $license_data);
    }
}
add_action('init', 'load_yith_li_ajax');
...
! defined( 'YITH_WCAN_VERSION' ) && define( 'YITH_WCAN_VERSION', '5.5.0' );
